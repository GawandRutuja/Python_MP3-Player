...
def addsongs():
    ...
    for s in temp_song:
        s=s.replace("D:\__pycache__\muisc","")    
...
def Play():
    ...
    song=f'D:\__pycache__\muisc\{song},""'   
...
def Previous():
    ...
    temp2=f'D:\__pycache__\muisc\{temp2}'
    mixer.music.load(songs_list.get(previous_one))
    mixer.music.play()
...
def Next():
    ...
    temp=f'D:\__pycache__\muisc\{temp}'
    mixer.music.load(songs_list.get(next_one))
    mixer.music.play()
    songs_list.selection_clear(0,END)
    #activate newsong
